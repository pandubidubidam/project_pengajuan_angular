...
@Component({
  selector: 'app-pengajuan-btt',
  templateUrl: './pengajuan-btt.component.html',
  styleUrls: ['./pengajuan-btt.component.css']
})
export class PengajuanBttComponent implements OnInit {
  ...
  submit(){
    ...
    } else if (this.services.uploadDocumentEditRKBAD.docValue.length < 1) {
      Swal.fire({
          icon: 'error',
          title: 'Gagal',
          text: 'Dokumen Rincian Kebutuhan Belanja atau Dokumen lain yg Dipersamakan Harus Di Upload!',
      })
    } else {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                console.log("this.services.uploadDocumentEditRKBAD =====> ", this.services.uploadDocumentEditRKBAD)
                console.log('submit')
                this.ajukan()
            }
        })
  ...
  ajukan(){
    this.services.ajukan.jenisPengajuan = 'BTT';
    ...
    this.services.ajukan.document = [
      ...
      { docId: this.services.uploadDocumentEditRKBAD.docId }
    ];
